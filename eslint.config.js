...
export default [
	...
	// For extensions
	{
		...
		rules: {
			...
			"extension/no-xmlhttprequest": "warn",
			"extension/iife": "warn",
			"extension/use-scratch-vm": "warn",
			"extension/use-scratch-fetch": "warn",
			"extension/use-scratch-open-window": "warn",
			"extension/use-scratch-redirect": "warn",
			"extension/check-can-fetch": "warn",
			"extension/no-translate-setup": "warn",
			"extension/no-translate-alias": "warn",
			"extension/should-translate": "warn",
			"extension/should-not-translate": "warn",
		},
	},
];
